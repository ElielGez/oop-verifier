...
class ComplexFunctionTest {
	...
	public void testDivConstructor(){
		...
		assertEquals(cfDiv.toString(), new ComplexFunction(Operation.Divid.toString(), f1, f2).toString());
	}

	@Test
	public void testMulConstructor(){
		assertEquals(cfMul.toString(), "mul(3.1+2.4x^2-x^4,5+2x-3.3x+0.1x^5)");
		assertEquals(cfMul.toString(), new ComplexFunction(Operation.Times.toString(), f1, f2).toString());
	}

	@Test
	public void testPlusConstructor(){
		assertEquals(cfPlus.toString(), "plus(3.1+2.4x^2-x^4,5+2x-3.3x+0.1x^5)");
		assertEquals(cfPlus.toString(), new ComplexFunction(Operation.Plus.toString(), f1, f2).toString());
	}

	@Test
	public void testMinConstructor(){
		assertEquals(cfMin.toString(), "min(3.1+2.4x^2-x^4,5+2x-3.3x+0.1x^5)");
		assertEquals(cfMin.toString(), new ComplexFunction(Operation.Min.toString(), f1, f2).toString());
	}

	@Test
	public void testMaxConstructor(){
		assertEquals(cfMax.toString(), "max(3.1+2.4x^2-x^4,5+2x-3.3x+0.1x^5)");
		assertEquals(cfMax.toString(), new ComplexFunction(Operation.Max.toString(), f1, f2).toString());
	}

	@Test
	public void testCompConstructor(){
		assertEquals(cfComp.toString(), "comp(3.1+2.4x^2-x^4,5+2x-3.3x+0.1x^5)");
		assertEquals(cfComp.toString(), new ComplexFunction(Operation.Comp.toString(), f1, f2).toString());
	}

	@Test
	public void testFPlus() {
		ComplexFunction cf1 = new ComplexFunction(Operation.Plus.toString(), cf.initFromString("-5x^2+3x"), cf.initFromString("7x^2-x"));
	...
	public void testFTimes(){
		ComplexFunction cf1 = new ComplexFunction(Operation.Times.toString(), cf.initFromString("-5x^2+3x"), cf.initFromString("7x^2-x"));
	...
	public void testFDivid(){
		ComplexFunction cf1 = new ComplexFunction(Operation.Divid.toString(), cf.initFromString("-5x^2+3x"), cf.initFromString("7x^2-x"));
	...
	public void testFMax(){
		ComplexFunction cf1 = new ComplexFunction(Operation.Max.toString(), cf.initFromString("7x^2-5"), cf.initFromString("x"));
	...
	public void testFMin(){
		ComplexFunction cf1 = new ComplexFunction(Operation.Min.toString(), cf.initFromString("7x^2-5"), cf.initFromString("x"));
	...
	public void testFComp(){
		ComplexFunction cf1 = new ComplexFunction(Operation.Comp.toString(), cf.initFromString("-5x^2+3x"), cf.initFromString("7x^2-x"));
	...
	public void testCopy() {
		ComplexFunction cf1 = new ComplexFunction(Operation.Times.toString(), cf.initFromString("-5x^2+3x"), cf.initFromString("x"));
	...
	public void testEquals(){
		assertTrue(cf.equals(new ComplexFunction(Operation.None.toString(), f1, f2)));
		assertTrue(cfDiv.equals(new ComplexFunction(Operation.Divid.toString(), f1, f2)));
		assertTrue(cfMul.equals(new ComplexFunction(Operation.Times.toString(), f1, f2)));
		assertTrue(cfPlus.equals(new ComplexFunction(Operation.Plus.toString(), f1, f2)));
		assertTrue(cfMin.equals(new ComplexFunction(Operation.Min.toString(), f1, f2)));
		assertTrue(cfMax.equals(new ComplexFunction(Operation.Max.toString(), f1, f2)));
		assertTrue(cfComp.equals(new ComplexFunction(Operation.Comp.toString(), f1, f2)));
	}
